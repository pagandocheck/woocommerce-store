...
function ecommerce_plus_general_admin_notice(){
         ...
         $msg = sprintf('<div data-dismissible="disable-done-notice-forever" class="notice notice-info" >
				...
				esc_html__('Theme Tutorials - Go Pro', 'ecommerce-plus'),
...
$ecommerce_plus_refreshed = isset($_SERVER['HTTP_CACHE_CONTROL'])
								&& ($_SERVER['HTTP_CACHE_CONTROL'] === 'max-age=0'
								||  $_SERVER['HTTP_CACHE_CONTROL'] == 'no-cache');

if (($ecommerce_plus_help_notice != 'notice-dismissed' || $ecommerce_plus_help_notice == '') && !$ecommerce_plus_refreshed ){
