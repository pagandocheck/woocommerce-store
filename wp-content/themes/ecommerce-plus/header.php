...
if ($ecommerce_plus_options['breadcrumb_show'] && !is_front_page()) :
    ...
    $ecommerce_plus_cat = $wp_query->get_queried_object();

    // get the thumbnail id using the queried category term_id
    $ecommerce_plus_thumbnail_id = get_woocommerce_term_meta( $ecommerce_plus_cat->term_id, 'thumbnail_id', true ); 

    // get the image URL
    $ecommerce_plus_image = wp_get_attachment_url( $ecommerce_plus_thumbnail_id ); 	
		$ecommerce_plus_header_image = $ecommerce_plus_image ? $ecommerce_plus_image : $ecommerce_plus_options['breadcrumb_image'];
	}
	?>
