...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="post-main-box">
    ...
    <div class="new-text">
      ...
      <?php if( get_theme_mod( 'vw_ecommerce_store_toggle_postdate',true) != '' || get_theme_mod( 'vw_ecommerce_store_toggle_author',true) != '' || get_theme_mod( 'vw_ecommerce_store_toggle_comments',true) != '' || get_theme_mod( 'vw_ecommerce_store_toggle_time',true) != '') { ?>
        <div class="post-info">
