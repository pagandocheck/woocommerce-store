			...
			<?php }else{ ?>
				...
				<div class="vw-ecommerce-store-pattern-page">
					...
					<p><b><?php esc_html_e('1. First you need to activate these plugins','vw-ecommerce-store'); ?></b></p>
	              	...
	              	<div class="vw-ecommerce-store-pattern-page">
			    			<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates&woo=true&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','vw-ecommerce-store'); ?></a>
			    		</div>
			    </div>
			<?php } ?>
		</div>
		...
		<div id="ecommerce_pro" class="tabcontent">
		    ...
		    <div class="col-left-pro">
		    	...
		    	<div class="pro-links">
					...
					<a href="<?php echo esc_url( VW_ECOMMERCE_STORE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Pro', 'vw-ecommerce-store'); ?></a>
